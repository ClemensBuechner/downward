...
class LandmarkFactoryHM : public LandmarkFactory {
    ...
    void get_m_sets_(const VariablesProxy &variables, int num_included, int current_var,
                     FluentSet &current,
    ...
    void get_m_sets(const VariablesProxy &variables, std::vector<FluentSet> &subsets);
    ...
    void get_split_m_sets(const VariablesProxy &variables, std::vector<FluentSet> &subsets,
                          const FluentSet &superset1, const FluentSet &superset2);
