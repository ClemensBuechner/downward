...
CONFIGS = [
    IssueConfig(f"lama-pref-all_interesting={all_interesting}",
                ["--if-unit-cost",
                 "--evaluator",
                 f"hlm=lmcount(lm_reasonable_orders_hps(lm_rhw()),pref=true,all_landmarks_interesting={all_interesting})",
                 "--evaluator", "hff=ff()",
                 "--search", """iterated([
                 ...
                 "--always"]) for all_interesting in [True, False]
]
...
exp.add_fetcher("data/issue1075-v1-base-lama-eval")
