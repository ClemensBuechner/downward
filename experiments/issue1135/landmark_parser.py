...
PATTERNS = [
    ...
    ["landmarks_derived", r"Landmark graph contains \d+ landmarks, of which \d+ are disjunctive, \d+ are conjunctive, and (\d+) are derived.", int],
    ["orderings", r"Landmark graph contains (\d+) orderings.", int],
    ["landmarks_dominance_pruned", r"Pruned (\d+) dominated landmarks.", int],
    ["orderings_deduced", r"Deduced (\d+) orderings.", int],
]
